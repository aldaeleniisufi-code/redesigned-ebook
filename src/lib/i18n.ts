...
const dictionaries = {
  el: {
    ...
    coloring: {
      ...
      note:
        "Αγόρασε αυτό το φυλλάδιο ζωγραφικής — η αγορά ισχύει για όλα τα παιδικά προφίλ του λογαριασμού σου.",
      buy: "Αγόρασε 🛒",
      sheet: "Σελίδα",
      download: "⬇ Κατέβασμα",
      print: "🖨 Εκτύπωση",
    ...
    adminColoring: {
      ...
      newPack: "➕ Νέο φυλλάδιο",
      newPackTitle: "Νέο Φυλλάδιο Ζωγραφικής 🎨",
      errorTitleCover: "Συμπλήρωσε τίτλο και ανέβασε εξώφυλλο.",
      createAddPages: "Δημιουργία & προσθήκη σελίδων",
      editTitle: "Επεξεργασία:",
      packDetails: "Στοιχεία φυλλαδίου",
      errorPageImage: "Χρειάζεται εικόνα για τη σελίδα.",
      newPage: "➕ Νέα σελίδα ζωγραφικής",
      addPage: "Προσθήκη σελίδας",
      pageImage: "Εικόνα ζωγραφικής (ασπρόμαυρη)",
    },
  },
  ...
  en: {
    ...
    coloring: {
      ...
      note:
        "Buy this coloring pack — the purchase works for all the child profiles on your account.",
      buy: "Buy 🛒",
      sheet: "Sheet",
      download: "⬇ Download",
      print: "🖨 Print",
    ...
    adminColoring: {
      ...
      newPack: "➕ New pack",
      newPackTitle: "New Coloring Pack 🎨",
      errorTitleCover: "Fill in a title and upload a cover.",
      createAddPages: "Create & add sheets",
      editTitle: "Edit:",
      packDetails: "Pack details",
      errorPageImage: "An image is required for the sheet.",
      newPage: "➕ New coloring sheet",
      addPage: "Add sheet",
      pageImage: "Coloring image (black & white)",
    },
  },
} as const;
